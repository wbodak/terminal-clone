...
const StoreTransfer = () => {
  ...
  const getStoreTransfers = () => {
    ...
    axiosGet({
      ...
      }&startDate=${today}&endDate=${today}&typeCode=62`,
      success: (data) => {
        setStockList(data);
      },
    });
    ...
    <Layout
      ...
      bottomProps={{
        saveProps: {
          ...
          onPress: async () => {
            axiosPost({
              path: `/Stock/CreateStockMasterForMaterialOutput?departmentId=${
                formState.department || 0
              }&storeId=${formState.sourceStore || 0}`,
              success: () => {
                getStoreTransfers();
              },
            });
    ...
    >
      ...
      <MyDataGrid
        ...
        columns={[
          ...
          {
            dataField: "STOCKMASTER_DEPARTMENTNAME",
            caption: "Departman",
            dataType: "string",
          },
          {
