...
const CompanyHelper = () => {
  ...
  const [companyParams, setCompanyParams] = useState({ typeId: 4, state: true })
  ...
  return (
    <View style={{ backgroundColor: '#16171A', height: '100%', width: '100%' }}>
      ...
      <View style={{ display: 'flex', flexDirection: 'row', width: '100%', gap: 10, paddingHorizontal: 16 }}>
        <MyDropdown
      ...
      <MyDataGrid
        ...
        columns={[
          ...
          { dataField: 'COMPANY_NAME', caption: 'Firma Adı', width: 300 },
